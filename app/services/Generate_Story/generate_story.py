...
2. "prompt": A dictionary with keys "page 0" through "page 13" and "page last page"
   ...
   - For coloring pages (12-13): Start with "Black and white coloring page illustration..." (no style needed). Describe a key scene with clear outlines, simple details, line art style, no shading/color. Still mention hair style, facial features for consistency. Include "Simple line drawing, no colors, no shading, suitable for children to color."
